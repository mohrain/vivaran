<x-app-layout>
   ...
   <a href="office.index"class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 ml-[50px] px-10 rounded-lg focus:outline-none focus:shadow-outline">+  नयाँ थप्नुहोस्</a> 
                                ...
                                @foreach ($offices as $office)
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-2  min-w-[200px]">
                                            ...
                                            <a href="{{ route('office.edit', $office->id) }}" class="text-yellow-500 hover:text-yellow-700">Edit</a> |
