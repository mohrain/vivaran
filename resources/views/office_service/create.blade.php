                      ...
                      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                          ...
                          <div class="mb-4">
                              ...
                              <select id="service_type" name="service_type" required
                                  ...
                                  <option value="IT Support" {{ old('service_type', $officeService->service_type ?? '') == 'IT Support' ? 'selected' : '' }}>IT Support</option>
                                  <option value="Other" {{ old('service_type', $officeService->service_type ?? '') == 'Other' ? 'selected' : '' }}>Other</option>
                              </select>
                              @error('service_type')
                                  <span class="text-red-500 text-sm">{{ $message }}</span>
                              @enderror
                          ...
                          <div class="mb-4">
                              ...
                              <textarea id="remark" name="remark"
                                     class="block w-full text-sm border rounded-lg bg-gray-50 px-3 py-2"></textarea>
                              @error('remark')
                                  <span class="text-red-500 text-sm">{{ $message }}</span>
                              @enderror
                          </div>
